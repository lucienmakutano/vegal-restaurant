<%-- 
    Document   : order
    Created on : 15-Aug-2020, 14:18:41
    Author     : kenne
--%>
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <h1 class="mt-4">Not in the mood to leave the house?</h1>
        <p>Click the link below to order your preferred meal and we'll deliver it to your doorstep.</p>

        <a
          href="javascript:void(
            window.open(
              'Food_Online_Order_Form.jsp',
              'blank',
              'scrollbars=yes,
              toolbar=no,
              width=700,
