...
if (window.JotForm && JotForm.accessible) $('input_17').setAttribute('tabindex',0);
    ...
    (function init(props) {
	  ...
	  var effects = function effects() {
	    ...
	    setInterval(handleUIUpdate, 250);
	  ...
	  var update = function update(newProps) {
	    state = getStateFromProps(newProps);
	    props = newProps;
	    load();
	  };
	  ...
	  return update;
	})({"text":{"text":"Question","value":"Reservation"},"labelAlign":{"text":"Label Align","value":"Top","dropdown":[["Auto","Auto"],["Left","Left"],["Right","Right"],["Top","Top"]]},"required":{"text":"Required","value":"No","dropdown":[["No","No"],["Yes","Yes"]]},"description":{"text":"Hover Text","value":"","textarea":true},"slotDuration":{"text":"Slot Duration","value":"60","dropdown":[[15,"15 min"],[30,"30 min"],[45,"45 min"],[60,"60 min"],["custom","Custom min"]],"hint":"Select how long each slot will be."},"startDate":{"text":"Start Date","value":""},"endDate":{"text":"End Date","value":""},"intervals":{"text":"Intervals","value":[{"from":"09:00","to":"22:00","days":["Mon","Tue","Wed","Thu","Fri","Sat","Sun"]}],"hint":"The hours will be applied to the selected days and repeated."},"useBlockout":{"text":"Blockout Custom Dates","value":"No","dropdown":[["No","No"],["Yes","Yes"]],"hint":"Disable certain date(s) in the calendar."},"blockoutDates":{"text":"Blockout dates","value":[{"startDate":"","endDate":""}]},"useLunchBreak":{"text":"Lunch Time","value":"No","dropdown":[["No","No"],["Yes","Yes"]],"hint":"Enable lunchtime in the calendar."},"lunchBreak":{"text":"Lunchtime hours","value":[{"from":"12:00","to":"14:00"}]},"timezone":{"text":"Timezone","value":"America/New_York (GMT-04:00)"},"timeFormat":{"text":"Time Format","value":"AM/PM","dropdown":[["24 Hour","24 Hour"],["AM/PM","AM/PM"]],"icon":"images/blank.gif","iconClassName":"toolbar-time_format_24"},"months":{"value":["January","February","March","April","May","June","July","August","September","October","November","December"],"hidden":true},"days":{"value":["Monday","Tuesday","Wednesday","Thursday","Friday","Saturday","Sunday"],"hidden":true},"startWeekOn":{"text":"Start Week On","value":"Sunday","dropdown":[["Monday","Monday"],["Sunday","Sunday"]],"toolbar":false},"rollingDays":{"text":"Rolling Days","value":"","toolbar":false},"appointmentType":{"hidden":true,"value":"multiple"},"dateFormat":{"hidden":true,"value":"mm/dd/yyyy"},"maxAttendee":{"hidden":true,"value":"10"},"minScheduleNotice":{"hidden":true,"value":"3"},"name":{"hidden":true,"value":"reservation"},"order":{"hidden":true,"value":"6"},"qid":{"toolbar":false,"value":"input_24"},"type":{"hidden":true,"value":"control_appointment"},"id":{"toolbar":false,"value":"24"},"qname":{"toolbar":false,"value":"q24_reservation"},"cdnconfig":{"CDN":"https://cdn.jotfor.ms/"},"passive":false,"formProperties":{"products":false,"highlightLine":"Enabled","coupons":false,"useStripeCoupons":false,"taxes":false,"comparePaymentForm":"","paymentListSettings":false,"newPaymentUIForNewCreatedForms":false},"formID":202207122956550,"themeVersion":"v2"});
...
if (window.JotForm && JotForm.accessible) $('input_7').setAttribute('tabindex',0);
   ...
   JotForm.prepareCalculationsOnTheFly([null,{"name":"1","qid":"1","text":"Submit Form","type":"control_button"},null,null,null,null,{"name":"phone","qid":"6","text":"Phone:","type":"control_textbox"},{"name":"anySpecial","qid":"7","text":"Any Special Request?","type":"control_textarea"},null,null,null,null,null,{"name":"tableReservation","qid":"13","text":"Table Reservation:","type":"control_dropdown"},null,null,{"name":"reservationType","qid":"16","text":"Reservation Type:","type":"control_dropdown"},{"name":"numberOf","qid":"17","text":"Number of Guests:","type":"control_textbox"},{"name":"katraReservation","qid":"18","text":"Reservation Form","type":"control_head"},null,{"name":"fullName","qid":"20","text":"Full Name:","type":"control_fullname"},{"name":"email","qid":"21","text":"E-mail:","type":"control_email"},{"name":"ifOther","qid":"22","text":"If Other above, please specify?","type":"control_textbox"},null,{"name":"reservation","qid":"24","text":"Reservation","type":"control_appointment"}]);
   setTimeout(function() {
JotForm.paymentExtrasOnTheFly([null,{"name":"1","qid":"1","text":"Submit Form","type":"control_button"},null,null,null,null,{"name":"phone","qid":"6","text":"Phone:","type":"control_textbox"},{"name":"anySpecial","qid":"7","text":"Any Special Request?","type":"control_textarea"},null,null,null,null,null,{"name":"tableReservation","qid":"13","text":"Table Reservation:","type":"control_dropdown"},null,null,{"name":"reservationType","qid":"16","text":"Reservation Type:","type":"control_dropdown"},{"name":"numberOf","qid":"17","text":"Number of Guests:","type":"control_textbox"},{"name":"katraReservation","qid":"18","text":"Reservation Form","type":"control_head"},null,{"name":"fullName","qid":"20","text":"Full Name:","type":"control_fullname"},{"name":"email","qid":"21","text":"E-mail:","type":"control_email"},{"name":"ifOther","qid":"22","text":"If Other above, please specify?","type":"control_textbox"},null,{"name":"reservation","qid":"24","text":"Reservation","type":"control_appointment"}]);}, 20); 
</script>
</head>
<body>
<form class="jotform-form" action="" method="post" name="form_202207122956550" id="" accept-charset="utf-8" autocomplete="on">
  ...
  <div role="main" class="form-all">
    <ul class="form-section page-section">
      ...
      <li class="form-line" data-type="control_fullname" id="id_20">
        <label class="form-label form-label-left form-label-auto" id="label_20" for="first_20"> Full Name: </label>
        <div id="cid_20" class="form-input" data-layout="full">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container " style="vertical-align:top" data-input-type="first">
              <input type="text" id="first_20" name="q20_fullName[first]" class="form-textbox" size="10" value="" data-component="first" aria-labelledby="label_20 sublabel_20_first" />
            ...
            <span class="form-sub-label-container " style="vertical-align:top" data-input-type="last">
              <input type="text" id="last_20" name="q20_fullName[last]" class="form-textbox" size="15" value="" data-component="last" aria-labelledby="label_20 sublabel_20_last" />
              <label class="form-sub-label" for="last_20" id="sublabel_20_last" style="min-height:13px" aria-hidden="false"> Last Name </label>
            </span>
          </div>
        </div>
      </li>
      <li class="form-line" data-type="control_email" id="id_21">
        <label class="form-label form-label-left form-label-auto" id="label_21" for="input_21"> E-mail: </label>
        <div id="cid_21" class="form-input" data-layout="half">
          <input type="email" id="input_21" name="q21_email" class="form-textbox validate[Email]" style="width:30px" size="30" value="" placeholder="ex: myname@example.com" data-component="email" aria-labelledby="label_21" />
        </div>
      </li>
      <li class="form-line" data-type="control_textbox" id="id_6">
        <label class="form-label form-label-left form-label-auto" id="label_6" for="input_6"> Phone: </label>
        <div id="cid_6" class="form-input" data-layout="half">
          <input type="text" id="input_6" name="q6_phone" data-type="input-textbox" class="form-textbox" style="width:20px" size="20" value="" maxLength="100" placeholder=" " data-component="textbox" aria-labelledby="label_6" />
        </div>
      </li>
      <li class="form-line" data-type="control_textbox" id="id_17">
        <label class="form-label form-label-left form-label-auto" id="label_17" for="input_17"> Number of Guests: </label>
        <div id="cid_17" class="form-input" data-layout="half">
          <input type="text" id="input_17" name="q17_numberOf" data-type="input-textbox" class="form-textbox validate[Numeric]" style="width:3px" size="3" value="" maxLength="100" placeholder=" " data-component="textbox" aria-labelledby="label_17" />
        </div>
      </li>
      <li class="form-line" data-type="control_appointment" id="id_24">
        <label class="form-label form-label-top" id="label_24" for="input_24"> Reservation </label>
        <div id="cid_24" class="form-input-wide" data-layout="full">
          <div id="input_24" class="appointmentFieldWrapper jfQuestion-fields">
            <input class="appointmentFieldInput " name="q24_reservation[date]" id="input_24_date" />
            <input class="appointmentFieldInput" name="q24_reservation[duration]" value="60" id="input_24_duration" />
            <input class="appointmentFieldInput" name="q24_reservation[timezone]" value="America/New_York (GMT-04:00)" id="input_24_timezone" />
      ...
      <li class="form-line" data-type="control_dropdown" id="id_13">
        <label class="form-label form-label-left form-label-auto" id="label_13" for="input_13"> Table Reservation: </label>
        <div id="cid_13" class="form-input" data-layout="half">
          <select class="form-dropdown" id="input_13" name="q13_tableReservation" style="width:150px" data-component="dropdown" aria-labelledby="label_13">
      ...
      <li class="form-line" data-type="control_dropdown" id="id_16">
        <label class="form-label form-label-left form-label-auto" id="label_16" for="input_16"> Reservation Type: </label>
        <div id="cid_16" class="form-input" data-layout="half">
          <select class="form-dropdown" id="input_16" name="q16_reservationType" style="width:150px" data-component="dropdown" aria-labelledby="label_16">
            <option value=""> Please Select </option>
      ...
      <li class="form-line" data-type="control_textbox" id="id_22">
        ...
        <div id="cid_22" class="form-input" data-layout="half">
          <input type="text" id="input_22" name="q22_ifOther" data-type="input-textbox" class="form-textbox" style="width:20px" size="20" value="" placeholder=" " data-component="textbox" aria-labelledby="label_22" />
        </div>
      </li>
      <li class="form-line" data-type="control_textarea" id="id_7">
        ...
        <div id="cid_7" class="form-input" data-layout="full">
          <textarea id="input_7" class="form-textarea" name="q7_anySpecial" style="width:40px;height:5px" data-component="textarea" aria-labelledby="label_7"></textarea>
        </div>
      </li>
  ...
  <input type="hidden" id="simple_spc" name="simple_spc" value="202207122956550" />
  <script type="text/javascript">
  document.getElementById("si" + "mple" + "_spc").value = "202207122956550-202207122956550";
  </script>
